...
func Resource(cx context.Context) []string {

	arrResource := make([]string, 3)
	...
	arrResource[2] = strRemoteIP

	return arrResource
}

func Logging(incResource []string, incTracecode string, incIdentity string, incMessage string, incError error) {
